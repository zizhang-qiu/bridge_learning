...
int EncodeHandEvaluationOneHot(const BridgeObservation& obs,
                               int start_offset,
                               std::vector<int>* encoding,
                               int relative_player);

int EncodeHandEvaluation(const BridgeObservation& obs,
                         int start_offset,
                         std::vector<int>* encoding,
                         int relative_player);
...
class CanonicalEncoder : public ObservationEncoder {
  public:
    ...
    Encode(const BridgeObservation& obs) const override;
