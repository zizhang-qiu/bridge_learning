...
template<class T>
T ParameterValue(const GameParameters&params,
                 const std::string&key,
                 T default_value);

template<>
int ParameterValue(const GameParameters&params,
                   const std::string&key,
                   int default_value);
template<>
double ParameterValue(const GameParameters&params,
                      const std::string&key,
                      double default_value);
template<>
std::string ParameterValue(const GameParameters&params,
                           const std::string&key,
                           std::string default_value);
template<>
bool ParameterValue(const GameParameters&params,
                    const std::string&key,
                    bool default_value);
...
(expr1==expr2 ? (void)0                                                            \
: (fprintf(stderr, "Input requirements failed at %s:%d in %s: %s vs %s\n", \
