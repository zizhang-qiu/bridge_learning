...
#ifndef BRIDGE_LEARNING_RELA_BATCHER_H_
#define BRIDGE_LEARNING_RELA_BATCHER_H_
...
class FutureReply {
 ...
 private:
  ...
  const int batchdim_;
  bool ready_;
  std::condition_variable_any cvReady_;
};
...
class Batcher {
 public:
  ...
  bool exit_ = false;
  std::condition_variable_any cvGetBatch_;
 ...
 private:
  ...
  int nextSlot_;
  int numActiveWrite_;
  std::condition_variable_any cvNextSlot_;
...
#endif //BRIDGE_LEARNING_RELA_BATCHER_H_
