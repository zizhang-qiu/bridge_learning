...
class BridgeEnv(GameEnv):
    ...
    def feature_size(self) -> Tuple[int, int, int]: ...
...
@overload
def load_encoder(
    name: str, game: bridge.BridgeGame, encoder_params: Dict[str, str]
) -> bridge.ObservationEncoder: ...
@overload
...
class BridgeFFWDActor(Actor):
    @overload
    def __init__(self, runner:pyrela.BatchRunner,
                 gamma_:float,
                 replay_buffer:pyrela.FFPrioritizedReplay,
                 player_idx:int):...
